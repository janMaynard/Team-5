...
<html lang="en">
    <head>
        ...
        <title>Gadget Store: Camera</title>
...
<!---------------------------------------------------------Store--------------------------------------------------------->
    ...
    <div class="page box2">
            <div class="item">
                <a href="Apple iPhone 13.html"><img src="<?php echo base_url("/resources/GadgetPics/Camera/Canon Eos 3000D.jpg");?>"></a>
                <div class="caption">
                    Canon Eos 3000D<br>
                    ₱50,990
                </div>
            ...
            <div class="item">
                <a href="Logitech Z120.html"><img src="<?php echo base_url("/resources/GadgetPics/Camera/Fujifilm X-T2.jpg");?>"></a>
                <div class="caption">
                    Fujifilm X-T2<br>
                    ₱45,329
                </div>
            ...
            <div class="item">
                <a href="Asus RT-AX55.html"><img src="<?php echo base_url("/resources/GadgetPics/Camera/nikon d3500.jpg");?>"></a>
                <div class="caption">
                    nikon d3500<br>
                    ₱51,095
                </div>
            ...
            <div class="item">
                <a href="Black Shark 4.html"><img src="<?php echo base_url("/resources/GadgetPics/Camera/POLAROID GO.png");?>"></a>
                <div class="caption">
                    POLAROID GO<br>
                    ₱23,950 
                </div>
            ...
            <div class="item">
                <a href="Canon Eos 3000D.html"><img src="<?php echo base_url("/resources/GadgetPics/Camera/SONY HANDYCAM FDR-AX43 UHD 4K CAMCORDER.jpg");?>"></a>
                <div class="caption">
                    SONY HANDYCAM FDR-AX43 UHD 4K CAMCORDER<br>
                    ₱20,269
                </div>
            </div>
            <div class="item">
                <a href="Canon Pixma G2010.html"><img src="<?php echo base_url("/resources/GadgetPics/Camera/SONY HANDYCAM HDR-CX405.jpg");?>"></a>
                <div class="caption">
                    SONY HANDYCAM HDR-CX405<br>
                    ₱20,269
                </div>
            </div>
        </div>
