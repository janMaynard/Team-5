...
<!---------------------------------------------------------item-details--------------------------------------------------------->
    <div class="box">
        <div class="item-container">
            <img src="<?php echo base_url("/resources/GadgetPics/Asus RT-AX55.jpg");?>">
            <div class="specs">
                <h3>Asus RT-AX55</h3>
                <h5>₱5,095</h5><br>
                Next-Gen Wi-Fi Standard - Supporting the latest Wi-Fi standard 802.11AX <br>
                (Wi-Fi 6) for better capacity and efficiency<br>
                Ultra-fast Wi-Fi Speed - RT-AX55 supports 1024-QAM for dramatically <br>
                faster wireless connections. With a total networking speed of about <br>
                1800Mbps — 574 Mbps on the 2.4GHz band and 1201 Mbps on the 5GHz band.
